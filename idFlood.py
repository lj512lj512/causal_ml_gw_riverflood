    ...
    for year, data_each_year in data_grouped:
        try:
            ...
            def plot_check():
                ...
                plt.plot(date[point_less_final_update], 
                         qobs[point_less_final_update], "*", color="yellow", ms=10)
                plt.plot(date[point_more_final_update], 
                         qobs[point_more_final_update], "*", color="orange", ms=10)
            ...
            for k in range(len(point_less_final_update)):
                ...
                out_file = savefile / f"{flood_number}.csv"
                flood_ini.to_csv(savefile / f"{flood_number}.csv")
